...
class dayuSms
{
     ...
     * @return stdClass
     */
    public static function sendSms($ACCESS_KEY_ID, $ACCESS_KEY_SECRET, $signName, $templateCode, $phoneNumbers, $templateParam = null, $outId = null) {
        ...
        // 发起访问请求
        $acsResponse = static::getAcsClient($ACCESS_KEY_ID, $ACCESS_KEY_SECRET)->getAcsResponse($request);
