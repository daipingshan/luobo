...
class AliConterBuilder
{
    ...
    {
        $this->body = $body;
        return $this->bizContentarr['body'] = $body;
    }

    public function setSubject($subject)
    {
        $this->subject = $subject;
        return $this->bizContentarr['subject'] = $subject;
    }
    ...
    public function setOutTradeNo($outTradeNo)
    {
        ...
        return $this->bizContentarr['out_trade_no'] = $outTradeNo;
    }

    public function setTimeExpress($timeExpress)
    {
        $this->timeExpress = $timeExpress;
        return $this->bizContentarr['timeout_express'] = $timeExpress;
    }
    ...
    public function setTotalAmount($totalAmount)
    {
        ...
        return $this->bizContentarr['total_amount'] = $totalAmount;
    }
