...
require dirname ( __FILE__ ).'/SignData.php';

class AopClient {
	//应用ID
	public $appId = '2017022105792369';
	//私钥文件路径
	public $rsaPrivateKeyFilePath = '';

	//私钥值
	public $rsaPrivateKey = '';
	//网关
	...
	*/
	public function pageExecute($request,$httpmethod = "POST") {
		...
		if ("GET" == $httpmethod) {
			...
			//拼接表单字符串			
			//var_dump($this->buildRequestForm($totalParams));
	...
	public function execute($request, $authToken = null, $appInfoAuthtoken = null) {
		...
		if ("json" == $this->format) {
			...
			// print_r($respObject);
			// die;
			//file_put_contents('/tmp/payres.log','json包：'.var_export($respObject, true).'**end',FILE_APPEND);
			if (null !== $respObject) {
				$respWellFormed = true;
