...
{	
	...
	public static function unified($inputObj, $timeOut = 6)
	{
		...
		file_put_contents('/tmp/wxloc.log',var_export($result, true).'&&',FILE_APPEND);
		return $result;
	}
	...
	{
		$chars = "abcdefghijklmnopqrstuvwxyz0123456789098";  
		$str ="";
		for ( $i = 0; $i < $length; $i++ )  {  
