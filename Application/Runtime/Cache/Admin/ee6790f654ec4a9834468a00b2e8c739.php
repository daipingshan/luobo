                ...
                <form class="layui-form" action="">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <select class="layui-select" name="project_id">
                    ...
                    <div class="layui-form-item" id="url">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="name" value="" placeholder="请输入项目名称"
                                   autocomplete="off"
                                   class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block" style="position: relative">
                            <input type="text" name="image" id="img-input"
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" name="salary_min" value="" placeholder="请输入最低薪资"
                                   class="layui-input">
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" name="salary_max" value="" placeholder="请输入最高薪资"
                                   class="layui-input">
                        </div>
                        <div class="layui-form-mid layui-word-aux">元</div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="contacts" value="" placeholder="请输入联系人"
                                   class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="tel" value="" placeholder="请输入联系电话"
                                   class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" name="sort" value="" placeholder="请输入项目排序"
                                   class="layui-input">
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" name="subsidy" value="0" placeholder="请输入项目补助"
                                   class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" name="rebate" value="0" placeholder="请输入返费金额"
                                   class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <script id="desc" type="text/plain"></script>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">工作地址</label>
                        <div class="layui-input-block">
                            <input type="text" name="address" value="" placeholder="请输入工作地址"
                                   class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
