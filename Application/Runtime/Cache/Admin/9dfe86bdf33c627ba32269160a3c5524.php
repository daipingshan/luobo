...
<script>
    ...
    <script type="text/html" id="table-edit">
        ...
        <a class="layui-btn layui-btn-xs layui-btn-danger del-advert"
           data-url="<?php echo U('delAdvertType');?>?id={{d.id}}">删除</a>
    </script>
    <script>
        $(function () {
            var index;
            form.render();
            var get_url = "<?php echo U('advertTypeList');?>";
            getData(get_url);
            ...
            $('body').on('click', '.del-advert', function () {
                ...
                layer.confirm('你确定要删除此广告分类？', function () {
            ...
            form.on("submit(save-admin)", function (data) {
                var _btn = data.elem;
                _btn.disabled = true;
                var url = "<?php echo U('saveAdvertType');?>"
