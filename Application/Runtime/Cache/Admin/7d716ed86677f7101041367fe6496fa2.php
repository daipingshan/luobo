    ...
    <form class="layui-form search" action="" name="search">
        <div class="layui-row">
            <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
                <a class="layui-btn layui-btn-danger" href="<?php echo U('authGroupDisplay');?>"><i class="layui-icon">
                    &#xe654;</i>添加权限组
                </a>
            </div>
        </div>
...
<script>
    ...
    <script type="text/html" id="table-edit">
        <a class="layui-btn layui-btn-xs" href="<?php echo U('authGroupDisplay');?>?id={{d.id}}">编辑</a>
    </script>
    ...
    <script>
        $(function () {
            form.render();
            var url = "<?php echo U('authGroupList');?>";
            refresh();
            ...
            form.on('switch(status)', function (obj) {
                $.post("<?php echo U('setGroupStatus');?>", {id: obj.value}, function (res) {
                    if (res.status == 1) {
