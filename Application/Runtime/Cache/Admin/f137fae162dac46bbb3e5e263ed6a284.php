...
<div class="layui-layout layui-layout-admin">
    ...
    <form class="layui-form search" action="" name="search">
        <div class="layui-row">
            ...
            <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
                <input type="text" name="user_name" value="<?php echo I('get.user_name');?>" placeholder="请输入姓名"
                       class="layui-input">
            </div>
            <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
                <input type="text" name="mobile" value="<?php echo I('get.mobile');?>" placeholder="请输入电话" class="layui-input">
            </div>
            <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
                <input type="hidden" name="shop_id" value="<?php echo I('get.shop_id',0,'int');?>">
...
<script>
    ...
    <script type="text/html" id="table-edit">
        ...
        <a class="layui-btn layui-btn-xs layui-btn-normal confirm"
           data-url="<?php echo U('setShopOrderStatus');?>?id={{d.id}}&status=1">审核成功</a>
        <a class="layui-btn layui-btn-xs layui-btn-danger confirm"
           data-url="<?php echo U('setShopOrderStatus');?>?id={{d.id}}&status=2">审核失败</a>
        {{#  } else if(d.check_up == 1) { }}
        <a class="layui-btn layui-btn-xs">通过</a>
        {{#  if(d.pay_status == 0){ }}
        <a class="layui-btn layui-btn-xs layui-btn-normal confirm"
           data-url="<?php echo U('setShopOrderPayStatus');?>?id={{d.id}}">立即付费</a>
        {{#  } else { }}
