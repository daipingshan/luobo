        ...
        <div class="layui-field-box">
            <div class="layui-col-md2">
                <div class="layui-card">
                    ...
                    <div class="layui-card-body">
                        <?php echo ($all_user_num); ?>
                    </div>
                </div>
            </div>
            <div class="layui-col-md2">
                <div class="layui-card">
                    <div class="layui-card-header"><i class="layui-icon">&#xe606;</i> 注册用户</div>
                    <div class="layui-card-body">
                        <?php echo ($user_num); ?>
                    </div>
                </div>
...
<script>
    ...
    <script type="text/html" id="status">
        ...
        <a class="layui-btn layui-btn-xs">注册用户</a>
        {{#  } }}
    </script>
    <script>
        $(function () {
            form.render();
            var tableObj;
            var url = "<?php echo U('userList');?>?user_id=<?php echo I('get.user_id');?>";
            refresh();
